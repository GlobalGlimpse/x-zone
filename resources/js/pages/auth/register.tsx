        ...
        <div className="w-full max-w-md rounded-xl bg-white shadow-xl border border-slate-200 dark:bg-white/5 dark:border-slate-700 backdrop-blur-md flex flex-col">
          <div className="p-8 bg-white dark:bg-transparent rounded-t-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Nom */}
              <div>
                <label htmlFor="name" className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Nom complet</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border py-3 pl-10 pr-3 bg-white dark:bg-slate-800 ${
                      errors.name ? 'border-red-500 text-red-500' : 'border-slate-300 text-slate-900 dark:text-white dark:border-slate-700'
              ...
              {/* Email */}
              <div>
                <label htmlFor="email" className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Adresse e-mail</label>
                <div className="relative">
              ...
              {/* Mot de passe */}
              <div>
                <label htmlFor="password" className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Mot de passe</label>
                <div className="relative">
              ...
              {/* Confirmation */}
              <div>
                <label htmlFor="password_confirmation" className="block text-sm text-slate-700 dark:text-slate-300 mb-1">Confirmez le mot de passe</label>
                <div className="relative">
                  <LockKeyhole className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400" />
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full rounded-lg border py-3 pl-10 pr-3 bg-white dark:bg-slate-800 ${
                      errors.password_confirmation ? 'border-red-500 text-red-500' : 'border-slate-300 text-slate-900 dark:text-white dark:border-slate-700'
                    } focus:ring-1 focus:ring-red-500 focus:outline-none`}
                  />
                </div>
          ...
          <div className="border-t border-slate-200 dark:border-slate-700 py-4 text-center text-sm text-slate-500 dark:bg-white/5 dark:text-slate-300 rounded-b-xl">
