      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-md rounded-xl bg-white/5 shadow-xl backdrop-blur-md border border-slate-700 flex flex-col">
          <div className="p-8">
            ...
            {status && (
              <div className="mb-4 rounded-lg bg-green-600/10 px-4 py-3 text-sm text-green-400 text-center">
                {status}
              </div>
            )}
          ...
          <div className="border-t border-slate-700 bg-white/5 text-center text-sm text-slate-300 py-4">
