  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0a0420] via-[#0e0a32] to-[#1B1749]">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-4xl rounded-xl bg-white/5 shadow-xl backdrop-blur-md border border-slate-700 overflow-hidden grid grid-cols-1 md:grid-cols-2">
          {/* Branding */}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full rounded-lg border py-3 pl-10 pr-3 bg-slate-800 ${
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className={`block w-full rounded-lg border py-3 pl-10 pr-10 bg-slate-800 ${
          ...
          {/* Footer */}
          <div className="col-span-full border-t border-slate-700 bg-white/5 text-center text-sm text-slate-300 py-4">
