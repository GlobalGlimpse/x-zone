          ...
          <div className="flex items-center gap-3 mb-6">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400">
                Suivi et traçabilité de toutes les tentatives de connexion
              </p>
            </div>
          </div>
                  ...
                  <tr>
                    ...
                    >
                      <div className="flex flex-col items-center gap-3">
                        <LogIn className="w-12 h-12 text-slate-300 dark:text-slate-600" />
                        <div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-col gap-2">
                        ...
                        {expanded.includes(log.id) && (
                          <div className="mt-2 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-lg p-3 space-y-2">
                            ...
                            <div className="flex items-start gap-2 text-xs text-slate-700 dark:text-slate-200">
                              ...
                              <div>
                                ...
                                <div className="text-slate-600 dark:text-slate-300 mt-1 max-w-xs break-words">
                                  {log.user_agent}
                                </div>
                              </div>
                            </div>
